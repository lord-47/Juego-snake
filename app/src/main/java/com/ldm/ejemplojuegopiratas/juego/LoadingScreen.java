...
public class LoadingScreen extends Pantalla{
    ...
    public void update(float deltaTime) {
        ...
        Assets.barcoarriba = g.newPixmap("serpientearriba.png", PixmapFormat.ARGB4444);
        Assets.barcoizquierda = g.newPixmap("serpienteizq.png", PixmapFormat.ARGB4444);
        Assets.barcoabajo = g.newPixmap("serpienteabajo.png", PixmapFormat.ARGB4444);
        Assets.barcoderecha = g.newPixmap("serpienteder.png", PixmapFormat.ARGB4444);
        Assets.tripulacion = g.newPixmap("cuerpo.png", PixmapFormat.ARGB4444);
        Assets.botin1 = g.newPixmap("frutas1.png", PixmapFormat.ARGB4444);
        Assets.botin2 = g.newPixmap("frutas2.png", PixmapFormat.ARGB4444);
        Assets.botin3 = g.newPixmap("frutas3.png", PixmapFormat.ARGB4444);
